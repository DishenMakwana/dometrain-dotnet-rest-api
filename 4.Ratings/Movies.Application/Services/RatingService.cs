...
public class RatingService: IRatingService
{
    ...
    public Task<IEnumerable<MovieRating>> GetRatingsOfUserAsync(Guid userId, CancellationToken token = default)
    {
        return _ratingRepository.GetRatingsOfUserAsync(userId, token);
    }
}